...
public class updateselectproduct extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		for(Map.Entry<String,Product> entry : hm2.entrySet())
		{
			...
			out.println("<input type=\"text\" class=\"uname\" placeholder=\"Enter Itemcondition\" value= '"+product.getName() +"' name=\"name\" required>");
			...
			out.println("<input type=\"text\" class=\"uname\" placeholder=\"Enter Itemcondition\" value= '"+product.getCondition() +"' name=\"Itemcondition\" required>");
			out.println("</div>");
			out.println("<div class=\"username\">");
			out.println("<label><b>Price$$ for 1 Quantity</b></label>");
			out.println("<input type=\"text\" class=\"uname\" placeholder=\"Enter Price\" name=\"Price\" value= '"+product.getPrice() +"' required>");
			out.println("</div>");
			out.println("<div class=\"username\">");
			out.println("<label><b>Product Image Name</b></label>");
			out.println("<input type=\"text\" class=\"uname\" placeholder=\"Enter image name only\" name=\"Imagepath\" value= '"+product.getImage() +"' required>");
			out.println("</div>");
			out.println("<div class=\"username\">");
			out.println("<label><b>Product Quantity</b></label>");
			out.println("<input type=\"text\" class=\"uname\" placeholder=\"Enter Quantity\" name=\"quantity\" value= '"+product.getQuantity() +"' required>");
			out.println("</div>");
			//out.println("</div>");
			out.println("<div class=\"username\">");
		...
		//	out.println("<option value = '\"product.getRebate()\"' >"+product.getRebate()+"</option>");
			...
			out.println("<button class=\"lbutton\" type=\"submit\" value=\"login\">Update Product</button>");
